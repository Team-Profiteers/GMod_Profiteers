...
if SERVER then
    function ENT:Think()
        ...
        if selfpos2d:Distance(droppos2d) < 1000 and not self.BombDropped then
            ...
            bomb:GetPhysicsObject():SetVelocityInstantaneous(self:GetRight() * 1000 + self:GetUp() * -5000000 + forward)
            ...
            bomb2:GetPhysicsObject():SetVelocityInstantaneous(self:GetRight() * -1000 + self:GetUp() * -5000000 + forward)
