...
net.Receive("pt_nuke", function()
    ...
    if Profiteers.HasNuke then
        ...
        Profiteers.NukeIsICBM = net.ReadBool()
    end
end)
...
hook.Add("HUDPaint", "Profiteers Nuke Warning", function()
    ...
    if Profiteers.GameOver then
        ...
        if Profiteers.NukeIsICBM then
            GAMEMODE:ShadowText(name .. " SUCCESSFULLY LAUNCHED AN ICBM", "CGHUD_4", ScrW() / 2, ScrH() / 3 + ScreenScale(2), Color(255, 0, 0), Color(0, 0, 0, 100), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP)
        else
    ...
    if Profiteers.NukeIsICBM then
        ...
        surface.SetFont("CGHUD_6")
        surface.SetTextPos(ScreenScale(48), ScreenScale(4))
        surface.DrawText("THERE IS NO HOPE")
        ...
        surface.SetFont("CGHUD_6")
        surface.SetTextPos(ScreenScale(48), ScreenScale(36))
        surface.DrawText(name .. " LAUNCHED ICBM")
